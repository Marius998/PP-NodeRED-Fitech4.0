        ...
        switch (currentState) {
			...
			(hbw->canColorBeStored(dps.getLastColor()))*/) {
                    ...
                    if (uid.length() == 8) //command uid has length=8
                    {
                        ...
                        } else if (((joyData.aX1 < -500) || dps.getUIDResetHBW() != uid) &&
                                   (dps.getUIDCalibMode().empty())) {
                    ...
                    if (joyData.b1) {
                        ...
                        switch (calibColor) {
                            ...
                            case ft::TxtWPType_t::WP_TYPE_BLUE:
                                ...
                                SPDLOG_LOGGER_DEBUG(spdlog::get("console"), "w:{} r:{} b:{}", calibColorValues[0],
                                ...
                                if ((calibColorValues[0] > 0) &&
                                    ...
                                    SPDLOG_LOGGER_DEBUG(spdlog::get("console"), "th1:{} th2:{}",
                                                        dps.calibData.color_th[0], dps.calibData.color_th[1]);
